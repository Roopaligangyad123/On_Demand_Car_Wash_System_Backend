...
public class OrderDetails 
{
	...
	public OrderDetails(@NotEmpty(message = "Order Id must not be empty") int orderId,
			...
			@NotEmpty(message = "vehicle type must not be empty") String vehicleType,
	...
	public String toString() {
		return "OrderDetails [orderId=" + orderId + ", carName=" + carName + ", vehicleType=" + vehicleType
				+ ", username=" + username + ", date=" + date + ", contactno=" + contactno + ", address=" + address
