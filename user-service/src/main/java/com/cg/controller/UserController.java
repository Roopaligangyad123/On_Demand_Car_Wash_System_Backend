...
public class UserController {
	...
	public List<Washpack> getwashpacks() {
		String baseurl = "http://localhost:8061/admin/washpack";
	...
	public String addrating(@RequestBody UserRating rating) {
		...
		return restTemplate.exchange("http://localhost:8061/admin/addrating", HttpMethod.POST, entity, String.class)
				.getBody();
	}
